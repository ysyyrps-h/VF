...
def first(img, bounding_boxes, threshold, err_list, id, center, contours_list, contours, flag1, flag2):
    for bbox in range(len(bounding_boxes)):
        ...
        ret, binary_roi = cv2.threshold(gray_roi, threshold - 10, 255, cv2.THRESH_BINARY)
